...
import { FAQS } from "~/lib/constants/faq-sponsors";
...
export default function FAQSponsors() {
  ...
  return (
    <div id="faq-sponsors" className="pb-10 sm:pb-16">
      <SectionHeader
        title="For Sponsors & Challenge Partners"
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 pr-8 sm:gap-60 sm:pr-28">
                    ...
                    <h2 className="-mb-2 text-left font-whyte text-base font-medium sm:text-xl md:text-2xl">
                      {item.q}
                    </h2>
                  </div>
